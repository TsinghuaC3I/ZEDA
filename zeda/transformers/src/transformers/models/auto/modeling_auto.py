...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("glm4_moe_lite_plus_plus", "Glm4MoeLitePlusPlusModel"),
        ("glm4v", "Glm4vModel"),
        ...
        ("qwen3_moe_plus_plus", "Qwen3MoePlusPlusModel"),
        ("qwen3_next", "Qwen3NextModel"),
        ("qwen3_next_plus_plus", "Qwen3NextPlusPlusModel"),
...
MODEL_FOR_CAUSAL_LM_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("glm4_moe_lite_plus_plus", "Glm4MoeLitePlusPlusForCausalLM"),
        ...
        ("qwen3_moe_plus_plus", "Qwen3MoePlusPlusForCausalLM"),
        ("qwen3_next", "Qwen3NextForCausalLM"),
        ("qwen3_next_plus_plus", "Qwen3NextPlusPlusForCausalLM"),
