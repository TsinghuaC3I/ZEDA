...
class Glm4MoeLiteAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # v4 API: use dict access instead of get_interface
...
class Glm4MoeLiteMoE(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        self.config = config
        # Use ModuleList to match checkpoint structure (each expert has separate gate/up/down proj)
    ...
    def moe(self, hidden_states: torch.Tensor, topk_indices: torch.Tensor, topk_weights: torch.Tensor):
        """Route tokens to experts and compute weighted sum of expert outputs."""
