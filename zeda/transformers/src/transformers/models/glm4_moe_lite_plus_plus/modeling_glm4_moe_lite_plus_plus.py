#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/glm4_moe_lite_plus_plus/modular_glm4_moe_lite_plus_plus.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_glm4_moe_lite_plus_plus.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class Glm4MoeLitePlusPlusRotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: Glm4MoeLitePlusPlusConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Optional[Glm4MoeLitePlusPlusConfig] = None,
...
class Glm4MoeLitePlusPlusAttention(nn.Module):
    ...
    def __init__(self, config: Glm4MoeLitePlusPlusConfig, layer_idx: int):
        ...
        if self.q_lora_rank is None:
            ...
            self.q_a_layernorm = Glm4MoeLitePlusPlusRMSNorm(config.q_lora_rank)
        ...
        self.kv_a_layernorm = Glm4MoeLitePlusPlusRMSNorm(self.kv_lora_rank)
...
class Glm4MoeLitePlusPlusMLP(nn.Module):
...
class Glm4MoeLitePlusPlusRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        Glm4MoeLitePlusPlusRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Glm4MoeLitePlusPlusMoE(nn.Module):
    """
    A mixed expert module containing shared experts and ZCE expert support.
    """
    ...
    def moe(self, hidden_states: torch.Tensor, topk_indices: torch.Tensor, topk_weights: torch.Tensor):
        """Route tokens to experts (including ZCE) and compute weighted sum of expert outputs."""
...
class Glm4MoeLitePlusPlusDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Glm4MoeLitePlusPlusConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
@auto_docstring
class Glm4MoeLitePlusPlusPreTrainedModel(PreTrainedModel):
    config: Glm4MoeLitePlusPlusConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Glm4MoeLitePlusPlusDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": Glm4MoeLitePlusPlusDecoderLayer,
        "attentions": Glm4MoeLitePlusPlusAttention,
    }

    def _init_weights(self, module):
        super()._init_weights(module)
        if isinstance(module, Glm4MoeLitePlusPlusTopkRouter):
            module.weight.data.normal_(mean=0.0, std=self.config.initializer_range)


@auto_docstring
class Glm4MoeLitePlusPlusModel(Glm4MoeLitePlusPlusPreTrainedModel):
    ...
    def __init__(self, config: Glm4MoeLitePlusPlusConfig):
        ...
        self.layers = nn.ModuleList(
            [Glm4MoeLitePlusPlusDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
        self.norm = Glm4MoeLitePlusPlusRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = Glm4MoeLitePlusPlusRotaryEmbedding(config=config)
...
@auto_docstring
class Glm4MoeLitePlusPlusForCausalLM(Glm4MoeLitePlusPlusPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = Glm4MoeLitePlusPlusModel(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Glm4MoeLitePlusPlusForCausalLM

        >>> model = Glm4MoeLitePlusPlusForCausalLM.from_pretrained("glm4-moe-lite-plus-plus")
        >>> tokenizer = AutoTokenizer.from_pretrained("glm4-moe-lite-plus-plus")
...
__all__ = ["Glm4MoeLitePlusPlusPreTrainedModel", "Glm4MoeLitePlusPlusModel", "Glm4MoeLitePlusPlusForCausalLM"]
