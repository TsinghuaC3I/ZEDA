...
class ModelConfig:
    ...
    def _derive_model_shapes(self):
        ...
        if (
            ...
            or "Glm4MoeLitePlusPlusForCausalLM" in self.hf_config.architectures
            ...
            if "Glm4MoeLiteForCausalLM" in self.hf_config.architectures or "Glm4MoeLitePlusPlusForCausalLM" in self.hf_config.architectures:
                self.scaling = 1
